...
public class PayrollServicesTestEasyMock {
	...
	public void setUpTestMockData()	{
		Associate associate1 = new Associate(101, 5000, "Sandeep", "Chand", "Dev", "Sr Con", "CVEP5674G", "Sandeep@gmail.com", new Salary(50000, 1000, 1000), new BankDetails(1122115, "KOTAK", "KTK00087"));
		...
		Associate associate3= new Associate( 2000, "Anvesh", "PSRJ", "Security", "Manager", "KJDFKD45K", "anvesh@gmail.com", new Salary(30000, 2000, 2000), new BankDetails(52244661, "CITYBANK", "CITY000034"));
		...
		EasyMock.expect(mockAssociateDao.findOne(17)).andReturn(null);
	...
	public void testGetAssociateDataForInvalidAssociateId() throws AssociateDetailsNotFoundException	{
					payrollServices.getAssociateDetails(17); 
		}
	/*
	@Test(expected= AssociateDetailsNotFoundException.class)
	...
	public void testGetAssociateDataForValidAssociateId() throws AssociateDetailsNotFoundException	{
		Associate expectedAssociate= new Associate(101, 5000, "Sandeep", "Chand", "Dev", "Sr Con", "CVEP5674G", "Sandeep@gmail.com", new Salary(50000, 1000, 1000), new BankDetails(1122115, "KOTAK", "KTK00087"));
